...
export function createParticle({ width, height }: { width: number, height: number }) {
    return {
        rgba: randomColour(),
...
export function animate(context: CanvasRenderingContext2D, width: number, height: number, particles: Particle[]) {
